...
class HomeNavigator(private val homeActivity :HomeActivity) {
    ...
    fun toCatalog() = this.homeActivity.findNavController(R.id.home_fragmentContainer)
        .navigate(R.id.catalogFragment)

    fun toSchedulePortrait() = this.homeActivity.findNavController(R.id.home_fragmentContainer)
        .navigate(R.id.schedulePortraitFragment)

    fun toEvaluations() = this.homeActivity.findNavController(R.id.home_fragmentContainer)
