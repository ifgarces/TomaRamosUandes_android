 ...
 * @property APP_LASTEST_VERSION_URL Used to query the lastest available version of the very same app
 ...
 * @property MAIN_APP_URL The main user link of this project, where general information and lastest
 * build are available.
 */
object WebManager {
    ...
    fun init(activity :Activity) {
        ...
        Logf("[WebManager] Current version is %s, lastest version is %s", currentVer, lastestVer)
